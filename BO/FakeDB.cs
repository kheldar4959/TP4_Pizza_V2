...
namespace TP4_Pizza_V2.BO
{
    public class FakeDB
    {
        public class FakeDb
        {
            //attributs qui autorise la réutilisation de la Db simulée
            private static FakeDb _instance;
            static readonly object instanceLock = new object();

            //Constructeur qui récupère les fake list Ingredients/Pates et génère une liste de pizza
            private FakeDb()
            {
            ...
            //Génération de l'instance à monter en mémoire
